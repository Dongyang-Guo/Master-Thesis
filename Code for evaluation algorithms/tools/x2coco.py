...
def main():
    ...
    parser.add_argument('--json_input_dir', default='data\origin_data\\all\json',help='input annotated directory')
    parser.add_argument('--image_input_dir', default='data\origin_data\\all\pic',help='image directory')
    parser.add_argument(
