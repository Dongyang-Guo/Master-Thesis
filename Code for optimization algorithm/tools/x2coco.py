...
def main():
    ...
    parser.add_argument('--json_input_dir', default=r'D:\dataset\fish_coco\all\json',help='input annotated directory')
    parser.add_argument('--image_input_dir', default=r'D:\dataset\fish_coco\all\pic',help='image directory')
    parser.add_argument(
